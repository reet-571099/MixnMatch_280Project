...
const Signup = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden py-12 px-4">
      ...
      >
        <Card className="p-8 bg-white/60 backdrop-blur-xl rounded-3xl border border-white/30 shadow-glow">
          <CardHeader className="space-y-4 pb-8">
            <motion.div
              initial={{ scale: 0 }}
              animate={{ scale: 1 }}
              transition={{ delay: 0.2, type: "spring", stiffness: 200 }}
              className="w-16 h-16 rounded-2xl bg-gradient-primary mx-auto flex items-center justify-center"
            >
            ...
            <CardDescription className="text-center text-base">
              Start your journey to stress-free cooking
            </CardDescription>
          </CardHeader>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    className="pl-10 h-12 bg-white/50 backdrop-blur border-white/50 rounded-xl"
                    required
                  />
                </div>
              </div>
        ...
        >
          Join 50,000+ home cooks transforming their kitchens
        </motion.p>
      </motion.div>
    </div>
  );
